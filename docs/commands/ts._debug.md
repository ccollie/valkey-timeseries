...
| `ts-fanout-aggregation-pushdown` | boolean | `yes`          | Shard-side aggregation/reduce push-down for clustered MRANGE; disable during rolling upgrades across this feature boundary |
