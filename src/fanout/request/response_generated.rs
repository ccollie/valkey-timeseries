...
impl<'a> ErrorResponse<'a> {
  ...
  pub fn error_code(&self) -> i16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i16>(ErrorResponse::VT_ERROR_CODE, Some(0)).unwrap()}
  }
  #[inline]
  pub fn error_message(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ErrorResponse::VT_ERROR_MESSAGE, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ErrorResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_error_code(&mut self, error_code: i16) {
    self.fbb_.push_slot::<i16>(ErrorResponse::VT_ERROR_CODE, error_code, 0);
  }
  #[inline]
  pub fn add_error_message(&mut self, error_message: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ErrorResponse::VT_ERROR_MESSAGE, error_message);
  }
  #[inline]
