...
impl<'b> flatbuffers::Push for Sample {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const Sample as *const u8, <Self as flatbuffers::Push>::size());
...
impl<'a> MGetValue<'a> {
  ...
  pub fn key(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MGetValue::VT_KEY, None)}
  }
  #[inline]
  ...
  pub fn labels(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Label<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Label>>>>(MGetValue::VT_LABELS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MGetValueBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MGetValue::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: &Sample) {
    self.fbb_.push_slot_always::<&Sample>(MGetValue::VT_VALUE, value);
  }
  #[inline]
  pub fn add_labels(&mut self, labels: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Label<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MGetValue::VT_LABELS, labels);
  }
  #[inline]
...
impl<'a> SeriesResponse<'a> {
  ...
  pub fn key(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(SeriesResponse::VT_KEY, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SeriesResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SeriesResponse::VT_KEY, key);
  }
  #[inline]
...
impl<'a> MultiGetResponse<'a> {
  ...
  #[inline]
  pub fn values(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MGetValue<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MGetValue>>>>(MultiGetResponse::VT_VALUES, None)}
  }
}
...
impl flatbuffers::Verifiable for MultiGetResponse<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<MGetValue>>>>("values", Self::VT_VALUES, false)?
     .finish();
    Ok(())
  }
}
pub struct MultiGetResponseArgs<'a> {
    pub values: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MGetValue<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MultiGetResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_values(&mut self, values: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MGetValue<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MultiGetResponse::VT_VALUES, values);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MultiGetResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> SeriesRangeResponse<'a> {
  ...
  pub fn key(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(SeriesRangeResponse::VT_KEY, None)}
  }
  #[inline]
  pub fn samples(&self) -> Option<flatbuffers::Vector<'a, Sample>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Sample>>>(SeriesRangeResponse::VT_SAMPLES, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SeriesRangeResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SeriesRangeResponse::VT_KEY, key);
  }
  #[inline]
  pub fn add_samples(&mut self, samples: flatbuffers::WIPOffset<flatbuffers::Vector<'b , Sample>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SeriesRangeResponse::VT_SAMPLES, samples);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SeriesRangeResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> RangeResponse<'a> {
  ...
  #[inline]
  pub fn series(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SeriesRangeResponse<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SeriesRangeResponse>>>>(RangeResponse::VT_SERIES, None)}
  }
}
...
impl flatbuffers::Verifiable for RangeResponse<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<SeriesRangeResponse>>>>("series", Self::VT_SERIES, false)?
     .finish();
    Ok(())
  }
}
pub struct RangeResponseArgs<'a> {
    pub series: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SeriesRangeResponse<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RangeResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_series(&mut self, series: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<SeriesRangeResponse<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RangeResponse::VT_SERIES, series);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RangeResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> MultiRangeResponse<'a> {
  ...
  #[inline]
  pub fn series(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SeriesResponse<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SeriesResponse>>>>(MultiRangeResponse::VT_SERIES, None)}
  }
}
...
impl flatbuffers::Verifiable for MultiRangeResponse<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<SeriesResponse>>>>("series", Self::VT_SERIES, false)?
     .finish();
    Ok(())
  }
}
pub struct MultiRangeResponseArgs<'a> {
    pub series: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SeriesResponse<'a>>>>>,
}
impl<'a> Default for MultiRangeResponseArgs<'a> {
  #[inline]
  fn default() -> Self {
    MultiRangeResponseArgs {
      series: None,
    }
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MultiRangeResponseBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_series(&mut self, series: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<SeriesResponse<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MultiRangeResponse::VT_SERIES, series);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MultiRangeResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> IndexQueryResponse<'a> {
  ...
  pub fn keys(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(IndexQueryResponse::VT_KEYS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> IndexQueryResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_keys(&mut self, keys: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(IndexQueryResponse::VT_KEYS, keys);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> IndexQueryResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> ErrorResponse<'a> {
  ...
  pub fn kind(&self) -> ErrorKind {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ErrorKind>(ErrorResponse::VT_KIND, Some(ErrorKind::Failed)).unwrap()}
  }
  #[inline]
  pub fn extra(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ErrorResponse::VT_EXTRA, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ErrorResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_kind(&mut self, kind: ErrorKind) {
    self.fbb_.push_slot::<ErrorKind>(ErrorResponse::VT_KIND, kind, ErrorKind::Failed);
  }
  #[inline]
  pub fn add_extra(&mut self, extra: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ErrorResponse::VT_EXTRA, extra);
  }
  #[inline]
...
impl<'a> LabelValuesResponse<'a> {
  ...
  pub fn values(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(LabelValuesResponse::VT_VALUES, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LabelValuesResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_values(&mut self, values: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LabelValuesResponse::VT_VALUES, values);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> LabelValuesResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> LabelNamesResponse<'a> {
  ...
  pub fn names(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(LabelNamesResponse::VT_NAMES, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LabelNamesResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_names(&mut self, names: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LabelNamesResponse::VT_NAMES, names);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> LabelNamesResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> CardinalityResponse<'a> {
  ...
  pub fn count(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(CardinalityResponse::VT_COUNT, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CardinalityResponseBuilder<'a, 'b, A> {
  ...
  pub fn add_count(&mut self, count: u64) {
    self.fbb_.push_slot::<u64>(CardinalityResponse::VT_COUNT, count, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> CardinalityResponseBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> PostingStat<'a> {
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PostingStat::VT_NAME, None)}
  }
  #[inline]
  pub fn count(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(PostingStat::VT_COUNT, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PostingStatBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PostingStat::VT_NAME, name);
  }
  #[inline]
  pub fn add_count(&mut self, count: u64) {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> PostingStatBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    PostingStatBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> PostingStats<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.label_value_pairs_stats { builder.add_label_value_pairs_stats(x); }
    if let Some(x) = args.label_value_stats { builder.add_label_value_stats(x); }
    if let Some(x) = args.cardinality_label_stats { builder.add_cardinality_label_stats(x); }
    if let Some(x) = args.cardinality_metrics_stats { builder.add_cardinality_metrics_stats(x); }
    builder.finish()
  }


  #[inline]
  pub fn cardinality_metrics_stats(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat>>>>(PostingStats::VT_CARDINALITY_METRICS_STATS, None)}
  }
  #[inline]
  pub fn cardinality_label_stats(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat>>>>(PostingStats::VT_CARDINALITY_LABEL_STATS, None)}
  }
  #[inline]
  pub fn label_value_stats(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat>>>>(PostingStats::VT_LABEL_VALUE_STATS, None)}
  }
  #[inline]
  pub fn label_value_pairs_stats(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat>>>>(PostingStats::VT_LABEL_VALUE_PAIRS_STATS, None)}
  }
  #[inline]
  pub fn num_label_pairs(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(PostingStats::VT_NUM_LABEL_PAIRS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn num_labels(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(PostingStats::VT_NUM_LABELS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn series_count(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(PostingStats::VT_SERIES_COUNT, Some(0)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for PostingStats<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PostingStat>>>>("cardinality_metrics_stats", Self::VT_CARDINALITY_METRICS_STATS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PostingStat>>>>("cardinality_label_stats", Self::VT_CARDINALITY_LABEL_STATS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PostingStat>>>>("label_value_stats", Self::VT_LABEL_VALUE_STATS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PostingStat>>>>("label_value_pairs_stats", Self::VT_LABEL_VALUE_PAIRS_STATS, false)?
...
pub struct PostingStatsArgs<'a> {
    pub cardinality_metrics_stats: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat<'a>>>>>,
    pub cardinality_label_stats: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat<'a>>>>>,
    pub label_value_stats: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat<'a>>>>>,
    pub label_value_pairs_stats: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PostingStat<'a>>>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PostingStatsBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_cardinality_metrics_stats(&mut self, cardinality_metrics_stats: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<PostingStat<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PostingStats::VT_CARDINALITY_METRICS_STATS, cardinality_metrics_stats);
  }
  #[inline]
  pub fn add_cardinality_label_stats(&mut self, cardinality_label_stats: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<PostingStat<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PostingStats::VT_CARDINALITY_LABEL_STATS, cardinality_label_stats);
  }
  #[inline]
  pub fn add_label_value_stats(&mut self, label_value_stats: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<PostingStat<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PostingStats::VT_LABEL_VALUE_STATS, label_value_stats);
  }
  #[inline]
  pub fn add_label_value_pairs_stats(&mut self, label_value_pairs_stats: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<PostingStat<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PostingStats::VT_LABEL_VALUE_PAIRS_STATS, label_value_pairs_stats);
  }
  #[inline]
  pub fn add_num_label_pairs(&mut self, num_label_pairs: u64) {
    self.fbb_.push_slot::<u64>(PostingStats::VT_NUM_LABEL_PAIRS, num_label_pairs, 0);
  }
  #[inline]
  pub fn add_num_labels(&mut self, num_labels: u64) {
    self.fbb_.push_slot::<u64>(PostingStats::VT_NUM_LABELS, num_labels, 0);
  }
  #[inline]
  pub fn add_series_count(&mut self, series_count: u64) {
    self.fbb_.push_slot::<u64>(PostingStats::VT_SERIES_COUNT, series_count, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> PostingStatsBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    PostingStatsBuilder {
      fbb_: _fbb,
      start_: start,
...
impl core::fmt::Debug for PostingStats<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("PostingStats");
      ds.field("cardinality_metrics_stats", &self.cardinality_metrics_stats());
