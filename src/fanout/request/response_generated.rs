...
#[inline]
/// Verifies that a buffer of bytes contains a `SeriesResponse`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_series_response_unchecked`.
pub fn root_as_series_response(buf: &[u8]) -> Result<SeriesResponse, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root::<SeriesResponse>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `SeriesResponse` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_series_response_unchecked`.
pub fn size_prefixed_root_as_series_response(buf: &[u8]) -> Result<SeriesResponse, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root::<SeriesResponse>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `SeriesResponse` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_series_response_unchecked`.
pub fn root_as_series_response_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<SeriesResponse<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root_with_opts::<SeriesResponse<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `SeriesResponse` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_series_response_unchecked`.
pub fn size_prefixed_root_as_series_response_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<SeriesResponse<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root_with_opts::<SeriesResponse<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a SeriesResponse and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `SeriesResponse`.
pub unsafe fn root_as_series_response_unchecked(buf: &[u8]) -> SeriesResponse {
  flatbuffers::root_unchecked::<SeriesResponse>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed SeriesResponse and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `SeriesResponse`.
pub unsafe fn size_prefixed_root_as_series_response_unchecked(buf: &[u8]) -> SeriesResponse {
  flatbuffers::size_prefixed_root_unchecked::<SeriesResponse>(buf)
}
#[inline]
pub fn finish_series_response_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<SeriesResponse<'a>>) {
  fbb.finish(root, None);
}

#[inline]
pub fn finish_size_prefixed_series_response_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<SeriesResponse<'a>>) {
