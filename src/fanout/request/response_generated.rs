...
impl<'a> SeriesChunk<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.group_value {
            builder.add_group_value(x);
        }
    ...
    pub fn group_value(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(SeriesChunk::VT_GROUP_VALUE, None)
        }
    }
    #[inline]
    pub fn labels(
...
impl<'a> SearchQueryResponse<'a> {
    ...
    pub fn series(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SeriesChunk<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SeriesChunk>>,
            >>(SearchQueryResponse::VT_SERIES, None)
        }
    }
}
...
impl flatbuffers::Verifiable for SearchQueryResponse<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<SeriesChunk>>,
            >>("series", Self::VT_SERIES, false)?
            .finish();
        Ok(())
    }
...
pub struct SearchQueryResponseArgs<'a> {
    pub series: Option<
        flatbuffers::WIPOffset<
            flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SeriesChunk<'a>>>,
        >,
    >,
}
impl<'a> Default for SearchQueryResponseArgs<'a> {
    #[inline]
    fn default() -> Self {
        SearchQueryResponseArgs { series: None }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SearchQueryResponseBuilder<'a, 'b, A> {
    ...
    pub fn add_series(
        &mut self,
        series: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<SeriesChunk<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(SearchQueryResponse::VT_SERIES, series);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> SearchQueryResponseBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
...
pub fn root_as_search_query_response(
    buf: &[u8],
) -> Result<SearchQueryResponse, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_search_query_response(
    buf: &[u8],
) -> Result<SearchQueryResponse, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_search_query_response_unchecked(
    buf: &[u8],
) -> SearchQueryResponse {
...
#[inline]
pub fn finish_size_prefixed_search_query_response_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<SearchQueryResponse<'a>>,
) {
