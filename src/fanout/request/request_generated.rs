...
impl<'a> RangeRequest<'a> {
  ...
  pub fn filters(&self) -> Option<Matchers<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Matchers>>(RangeRequest::VT_FILTERS, None)}
  }
}
...
impl flatbuffers::Verifiable for RangeRequest<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<Matchers>>("filters", Self::VT_FILTERS, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RangeRequestBuilder<'a, 'b, A> {
  ...
  pub fn add_filters(&mut self, filters: flatbuffers::WIPOffset<Matchers<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Matchers>>(RangeRequest::VT_FILTERS, filters);
  }
  #[inline]
...
impl<'a> MultiGetRequest<'a> {
  ...
  pub fn filter(&self) -> Option<Matchers<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Matchers>>(MultiGetRequest::VT_FILTER, None)}
  }
}
...
impl flatbuffers::Verifiable for MultiGetRequest<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<Matchers>>("filter", Self::VT_FILTER, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MultiGetRequestBuilder<'a, 'b, A> {
  ...
  pub fn add_filter(&mut self, filter: flatbuffers::WIPOffset<Matchers<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Matchers>>(MultiGetRequest::VT_FILTER, filter);
  }
  #[inline]
...
impl<'a> IndexQueryRequest<'a> {
  ...
  pub fn filter(&self) -> Option<Matchers<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Matchers>>(IndexQueryRequest::VT_FILTER, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> IndexQueryRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_filter(&mut self, filter: flatbuffers::WIPOffset<Matchers<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Matchers>>(IndexQueryRequest::VT_FILTER, filter);
  }
  #[inline]
...
impl<'a> LabelNamesRequest<'a> {
  ...
  pub fn filter(&self) -> Option<Matchers<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Matchers>>(LabelNamesRequest::VT_FILTER, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LabelNamesRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_filter(&mut self, filter: flatbuffers::WIPOffset<Matchers<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Matchers>>(LabelNamesRequest::VT_FILTER, filter);
  }
  #[inline]
...
impl<'a> LabelValuesRequest<'a> {
  ...
  pub fn filter(&self) -> Option<Matchers<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Matchers>>(LabelValuesRequest::VT_FILTER, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LabelValuesRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_filter(&mut self, filter: flatbuffers::WIPOffset<Matchers<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Matchers>>(LabelValuesRequest::VT_FILTER, filter);
  }
  #[inline]
...
impl<'a> CardinalityRequest<'a> {
  ...
  pub fn filter(&self) -> Option<Matchers<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Matchers>>(CardinalityRequest::VT_FILTER, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CardinalityRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_filter(&mut self, filter: flatbuffers::WIPOffset<Matchers<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Matchers>>(CardinalityRequest::VT_FILTER, filter);
  }
  #[inline]
...
impl<'a> MultiRangeRequest<'a> {
  ...
  pub fn filter(&self) -> Option<Matchers<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Matchers>>(MultiRangeRequest::VT_FILTER, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MultiRangeRequestBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_filter(&mut self, filter: flatbuffers::WIPOffset<Matchers<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Matchers>>(MultiRangeRequest::VT_FILTER, filter);
  }
  #[inline]
