...
impl<'a> SearchQueryRequest<'a> {
    ...
    pub fn start(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(SearchQueryRequest::VT_START, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn end(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(SearchQueryRequest::VT_END, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn matchers(&self) -> Option<Matchers<'a>> {
        ...
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<Matchers>>(
                SearchQueryRequest::VT_MATCHERS,
                None,
            )
        }
    }
    ...
    pub fn limit(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(SearchQueryRequest::VT_LIMIT, Some(1000))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SearchQueryRequestBuilder<'a, 'b, A> {
    ...
    pub fn add_start(&mut self, start: i64) {
        self.fbb_
            .push_slot::<i64>(SearchQueryRequest::VT_START, start, 0);
    }
    #[inline]
    pub fn add_end(&mut self, end: i64) {
        self.fbb_
            .push_slot::<i64>(SearchQueryRequest::VT_END, end, 0);
    }
    #[inline]
    ...
    pub fn add_limit(&mut self, limit: u32) {
        self.fbb_
            .push_slot::<u32>(SearchQueryRequest::VT_LIMIT, limit, 1000);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> SearchQueryRequestBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
...
pub fn root_as_search_query_request(
    buf: &[u8],
) -> Result<SearchQueryRequest, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_search_query_request(
    buf: &[u8],
) -> Result<SearchQueryRequest, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_search_query_request_unchecked(
    buf: &[u8],
) -> SearchQueryRequest {
...
#[inline]
pub fn finish_size_prefixed_search_query_request_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<SearchQueryRequest<'a>>,
) {
