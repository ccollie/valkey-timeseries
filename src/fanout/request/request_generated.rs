...
impl<'b> flatbuffers::Push for ValueRangeFilter {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const ValueRangeFilter as *const u8, <Self as flatbuffers::Push>::size());
...
impl<'a> Matcher<'a> {
  ...
  pub fn label(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Matcher::VT_LABEL, None)}
  }
  #[inline]
  pub fn op(&self) -> MatchOpType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<MatchOpType>(Matcher::VT_OP, Some(MatchOpType::Equal)).unwrap()}
  }
  #[inline]
  pub fn value(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(Matcher::VT_VALUE, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MatcherBuilder<'a, 'b, A> {
  ...
  pub fn add_group_id(&mut self, group_id: u16) {
    self.fbb_.push_slot::<u16>(Matcher::VT_GROUP_ID, group_id, 0);
  }
  #[inline]
  pub fn add_label(&mut self, label: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Matcher::VT_LABEL, label);
  }
  #[inline]
  pub fn add_op(&mut self, op: MatchOpType) {
    self.fbb_.push_slot::<MatchOpType>(Matcher::VT_OP, op, MatchOpType::Equal);
  }
  #[inline]
  pub fn add_value(&mut self, value: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Matcher::VT_VALUE, value);
  }
  #[inline]
...
impl<'a> Matchers<'a> {
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Matchers::VT_NAME, None)}
  }
  #[inline]
  pub fn condition(&self) -> MatchersCondition {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<MatchersCondition>(Matchers::VT_CONDITION, Some(MatchersCondition::And)).unwrap()}
  }
  #[inline]
  pub fn matchers(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matcher<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matcher>>>>(Matchers::VT_MATCHERS, None)}
  }
}
...
impl flatbuffers::Verifiable for Matchers<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Matcher>>>>("matchers", Self::VT_MATCHERS, false)?
     .finish();
    Ok(())
  }
}
pub struct MatchersArgs<'a> {
    ...
    pub matchers: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matcher<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MatchersBuilder<'a, 'b, A> {
  ...
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Matchers::VT_NAME, name);
  }
  #[inline]
  pub fn add_condition(&mut self, condition: MatchersCondition) {
    self.fbb_.push_slot::<MatchersCondition>(Matchers::VT_CONDITION, condition, MatchersCondition::And);
  }
  #[inline]
  pub fn add_matchers(&mut self, matchers: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Matcher<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Matchers::VT_MATCHERS, matchers);
  }
  #[inline]
...
impl<'a> MultiGetRequest<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.selected_labels { builder.add_selected_labels(x); }
  ...
  pub fn with_labels(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(MultiGetRequest::VT_WITH_LABELS, Some(false)).unwrap()}
  }
  #[inline]
  pub fn selected_labels(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MultiGetRequest::VT_SELECTED_LABELS, None)}
  }
  #[inline]
  pub fn filters(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers>>>>(MultiGetRequest::VT_FILTERS, None)}
  }
}
...
impl flatbuffers::Verifiable for MultiGetRequest<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>>>("selected_labels", Self::VT_SELECTED_LABELS, false)?
...
pub struct MultiGetRequestArgs<'a> {
    ...
    pub selected_labels: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MultiGetRequestBuilder<'a, 'b, A> {
  ...
  pub fn add_with_labels(&mut self, with_labels: bool) {
    self.fbb_.push_slot::<bool>(MultiGetRequest::VT_WITH_LABELS, with_labels, false);
  }
  #[inline]
  pub fn add_selected_labels(&mut self, selected_labels: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MultiGetRequest::VT_SELECTED_LABELS, selected_labels);
  }
  #[inline]
  pub fn add_filters(&mut self, filters: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Matchers<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MultiGetRequest::VT_FILTERS, filters);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MultiGetRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> IndexQueryRequest<'a> {
  ...
  pub fn range(&self) -> Option<DateRange<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<DateRange>>(IndexQueryRequest::VT_RANGE, None)}
  }
  #[inline]
  pub fn filters(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers>>>>(IndexQueryRequest::VT_FILTERS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> IndexQueryRequestBuilder<'a, 'b, A> {
  ...
  pub fn add_range(&mut self, range: flatbuffers::WIPOffset<DateRange<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<DateRange>>(IndexQueryRequest::VT_RANGE, range);
  }
  #[inline]
  pub fn add_filters(&mut self, filters: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Matchers<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(IndexQueryRequest::VT_FILTERS, filters);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> IndexQueryRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> LabelNamesRequest<'a> {
  ...
  pub fn range(&self) -> Option<DateRange<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<DateRange>>(LabelNamesRequest::VT_RANGE, None)}
  }
  #[inline]
  pub fn filters(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers>>>>(LabelNamesRequest::VT_FILTERS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LabelNamesRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_range(&mut self, range: flatbuffers::WIPOffset<DateRange<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<DateRange>>(LabelNamesRequest::VT_RANGE, range);
  }
  #[inline]
  pub fn add_filters(&mut self, filters: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Matchers<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LabelNamesRequest::VT_FILTERS, filters);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> LabelNamesRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> LabelValuesRequest<'a> {
  ...
  pub fn label(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LabelValuesRequest::VT_LABEL, None)}
  }
  #[inline]
  pub fn range(&self) -> Option<DateRange<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<DateRange>>(LabelValuesRequest::VT_RANGE, None)}
  }
  #[inline]
  pub fn filters(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers>>>>(LabelValuesRequest::VT_FILTERS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LabelValuesRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_label(&mut self, label: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LabelValuesRequest::VT_LABEL, label);
  }
  #[inline]
  pub fn add_range(&mut self, range: flatbuffers::WIPOffset<DateRange<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<DateRange>>(LabelValuesRequest::VT_RANGE, range);
  }
  #[inline]
  pub fn add_filters(&mut self, filters: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Matchers<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LabelValuesRequest::VT_FILTERS, filters);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> LabelValuesRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> CardinalityRequest<'a> {
  ...
  pub fn range(&self) -> Option<DateRange<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<DateRange>>(CardinalityRequest::VT_RANGE, None)}
  }
  #[inline]
  pub fn filters(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers>>>>(CardinalityRequest::VT_FILTERS, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CardinalityRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_range(&mut self, range: flatbuffers::WIPOffset<DateRange<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<DateRange>>(CardinalityRequest::VT_RANGE, range);
  }
  #[inline]
  pub fn add_filters(&mut self, filters: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Matchers<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(CardinalityRequest::VT_FILTERS, filters);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> CardinalityRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> AggregationOptions<'a> {
  ...
  pub fn aggregator(&self) -> AggregationType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<AggregationType>(AggregationOptions::VT_AGGREGATOR, Some(AggregationType::Sum)).unwrap()}
  }
  #[inline]
  pub fn bucket_duration(&self) -> u64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(AggregationOptions::VT_BUCKET_DURATION, Some(0)).unwrap()}
  }
  #[inline]
  pub fn timestamp_output(&self) -> BucketTimestampType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<BucketTimestampType>(AggregationOptions::VT_TIMESTAMP_OUTPUT, Some(BucketTimestampType::Start)).unwrap()}
  }
  #[inline]
  pub fn bucket_alignment(&self) -> BucketAlignmentType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<BucketAlignmentType>(AggregationOptions::VT_BUCKET_ALIGNMENT, Some(BucketAlignmentType::Default)).unwrap()}
  }
  #[inline]
  pub fn alignment_timestamp(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(AggregationOptions::VT_ALIGNMENT_TIMESTAMP, Some(0)).unwrap()}
  }
  #[inline]
  pub fn report_empty(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(AggregationOptions::VT_REPORT_EMPTY, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for AggregationOptions<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<BucketTimestampType>("timestamp_output", Self::VT_TIMESTAMP_OUTPUT, false)?
     .visit_field::<BucketAlignmentType>("bucket_alignment", Self::VT_BUCKET_ALIGNMENT, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AggregationOptionsBuilder<'a, 'b, A> {
  ...
  pub fn add_aggregator(&mut self, aggregator: AggregationType) {
    self.fbb_.push_slot::<AggregationType>(AggregationOptions::VT_AGGREGATOR, aggregator, AggregationType::Sum);
  }
  #[inline]
  pub fn add_bucket_duration(&mut self, bucket_duration: u64) {
    self.fbb_.push_slot::<u64>(AggregationOptions::VT_BUCKET_DURATION, bucket_duration, 0);
  }
  #[inline]
  pub fn add_timestamp_output(&mut self, timestamp_output: BucketTimestampType) {
    self.fbb_.push_slot::<BucketTimestampType>(AggregationOptions::VT_TIMESTAMP_OUTPUT, timestamp_output, BucketTimestampType::Start);
  }
  #[inline]
  pub fn add_bucket_alignment(&mut self, bucket_alignment: BucketAlignmentType) {
    self.fbb_.push_slot::<BucketAlignmentType>(AggregationOptions::VT_BUCKET_ALIGNMENT, bucket_alignment, BucketAlignmentType::Default);
  }
  #[inline]
  pub fn add_alignment_timestamp(&mut self, alignment_timestamp: i64) {
    self.fbb_.push_slot::<i64>(AggregationOptions::VT_ALIGNMENT_TIMESTAMP, alignment_timestamp, 0);
  }
  #[inline]
  pub fn add_report_empty(&mut self, report_empty: bool) {
    self.fbb_.push_slot::<bool>(AggregationOptions::VT_REPORT_EMPTY, report_empty, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> AggregationOptionsBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> GroupingOptions<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.group_label { builder.add_group_label(x); }
    builder.add_aggregator(args.aggregator);
    builder.finish()
  }
  ...
  pub fn group_label(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(GroupingOptions::VT_GROUP_LABEL, None)}
  }
  #[inline]
  pub fn aggregator(&self) -> AggregationType {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<AggregationType>(GroupingOptions::VT_AGGREGATOR, Some(AggregationType::Sum)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for GroupingOptions<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("group_label", Self::VT_GROUP_LABEL, false)?
     .visit_field::<AggregationType>("aggregator", Self::VT_AGGREGATOR, false)?
     .finish();
    Ok(())
  }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GroupingOptionsBuilder<'a, 'b, A> {
  ...
  pub fn add_group_label(&mut self, group_label: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(GroupingOptions::VT_GROUP_LABEL, group_label);
  }
  #[inline]
  pub fn add_aggregator(&mut self, aggregator: AggregationType) {
    self.fbb_.push_slot::<AggregationType>(GroupingOptions::VT_AGGREGATOR, aggregator, AggregationType::Sum);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> GroupingOptionsBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl<'a> RangeRequest<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.aggregation { builder.add_aggregation(x); }
    if let Some(x) = args.value_filter { builder.add_value_filter(x); }
    if let Some(x) = args.timestamp_filter { builder.add_timestamp_filter(x); }
  ...
  pub fn range(&self) -> Option<DateRange<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<DateRange>>(RangeRequest::VT_RANGE, None)}
  }
  #[inline]
  pub fn count(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(RangeRequest::VT_COUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn timestamp_filter(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(RangeRequest::VT_TIMESTAMP_FILTER, None)}
  }
  #[inline]
  pub fn value_filter(&self) -> Option<&'a ValueRangeFilter> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ValueRangeFilter>(RangeRequest::VT_VALUE_FILTER, None)}
  }
  #[inline]
  pub fn aggregation(&self) -> Option<AggregationOptions<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<AggregationOptions>>(RangeRequest::VT_AGGREGATION, None)}
  }
}
...
impl flatbuffers::Verifiable for RangeRequest<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("timestamp_filter", Self::VT_TIMESTAMP_FILTER, false)?
     .visit_field::<ValueRangeFilter>("value_filter", Self::VT_VALUE_FILTER, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<AggregationOptions>>("aggregation", Self::VT_AGGREGATION, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RangeRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_range(&mut self, range: flatbuffers::WIPOffset<DateRange<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<DateRange>>(RangeRequest::VT_RANGE, range);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_timestamp_filter(&mut self, timestamp_filter: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RangeRequest::VT_TIMESTAMP_FILTER, timestamp_filter);
  }
  #[inline]
  pub fn add_value_filter(&mut self, value_filter: &ValueRangeFilter) {
    self.fbb_.push_slot_always::<&ValueRangeFilter>(RangeRequest::VT_VALUE_FILTER, value_filter);
  }
  #[inline]
  pub fn add_aggregation(&mut self, aggregation: flatbuffers::WIPOffset<AggregationOptions<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<AggregationOptions>>(RangeRequest::VT_AGGREGATION, aggregation);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RangeRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    RangeRequestBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> MultiRangeRequest<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.grouping { builder.add_grouping(x); }
    if let Some(x) = args.aggregation { builder.add_aggregation(x); }
    if let Some(x) = args.filters { builder.add_filters(x); }
    if let Some(x) = args.selected_labels { builder.add_selected_labels(x); }
    if let Some(x) = args.value_filter { builder.add_value_filter(x); }
  ...
  pub fn range(&self) -> Option<DateRange<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<DateRange>>(MultiRangeRequest::VT_RANGE, None)}
  }
  #[inline]
  pub fn count(&self) -> u32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(MultiRangeRequest::VT_COUNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn timestamp_filter(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(MultiRangeRequest::VT_TIMESTAMP_FILTER, None)}
  }
  #[inline]
  pub fn value_filter(&self) -> Option<&'a ValueRangeFilter> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ValueRangeFilter>(MultiRangeRequest::VT_VALUE_FILTER, None)}
  }
  #[inline]
  pub fn with_labels(&self) -> bool {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(MultiRangeRequest::VT_WITH_LABELS, Some(false)).unwrap()}
  }
  #[inline]
  pub fn selected_labels(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MultiRangeRequest::VT_SELECTED_LABELS, None)}
  }
  #[inline]
  pub fn filters(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Matchers>>>>(MultiRangeRequest::VT_FILTERS, None)}
  }
  #[inline]
  pub fn aggregation(&self) -> Option<AggregationOptions<'a>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<AggregationOptions>>(MultiRangeRequest::VT_AGGREGATION, None)}
  }
  #[inline]
  pub fn grouping(&self) -> Option<GroupingOptions<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<GroupingOptions>>(MultiRangeRequest::VT_GROUPING, None)}
  }
}
...
impl flatbuffers::Verifiable for MultiRangeRequest<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Matchers>>>>("filters", Self::VT_FILTERS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<AggregationOptions>>("aggregation", Self::VT_AGGREGATION, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<GroupingOptions>>("grouping", Self::VT_GROUPING, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MultiRangeRequestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_range(&mut self, range: flatbuffers::WIPOffset<DateRange<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<DateRange>>(MultiRangeRequest::VT_RANGE, range);
  }
  #[inline]
  pub fn add_count(&mut self, count: u32) {
    self.fbb_.push_slot::<u32>(MultiRangeRequest::VT_COUNT, count, 0);
  }
  #[inline]
  pub fn add_timestamp_filter(&mut self, timestamp_filter: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MultiRangeRequest::VT_TIMESTAMP_FILTER, timestamp_filter);
  }
  #[inline]
  pub fn add_value_filter(&mut self, value_filter: &ValueRangeFilter) {
    self.fbb_.push_slot_always::<&ValueRangeFilter>(MultiRangeRequest::VT_VALUE_FILTER, value_filter);
  }
  #[inline]
  pub fn add_with_labels(&mut self, with_labels: bool) {
    self.fbb_.push_slot::<bool>(MultiRangeRequest::VT_WITH_LABELS, with_labels, false);
  }
  #[inline]
  pub fn add_selected_labels(&mut self, selected_labels: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MultiRangeRequest::VT_SELECTED_LABELS, selected_labels);
  }
  #[inline]
  pub fn add_filters(&mut self, filters: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Matchers<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MultiRangeRequest::VT_FILTERS, filters);
  }
  #[inline]
  pub fn add_aggregation(&mut self, aggregation: flatbuffers::WIPOffset<AggregationOptions<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<AggregationOptions>>(MultiRangeRequest::VT_AGGREGATION, aggregation);
  }
  #[inline]
  pub fn add_grouping(&mut self, grouping: flatbuffers::WIPOffset<GroupingOptions<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<GroupingOptions>>(MultiRangeRequest::VT_GROUPING, grouping);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MultiRangeRequestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
