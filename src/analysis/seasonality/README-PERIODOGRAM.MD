...
Code is copied from `augurs-seasons`, and contains methods for detecting seasonality or periodicity in time series.
...
```rust
use crate::analysis::seasonality::{Detector, PeriodogramDetector};
...
Original Code: [Augurs Seasons](https://crates.io/crates/augurs-seasons)
