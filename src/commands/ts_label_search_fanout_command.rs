...
use crate::commands::fanout::{LabelSearchResult, LabelSearchType};
use crate::commands::ts_labelnamesearch::{
    process_label_name_search_request, LabelNameSearchArgs,
};
...
pub struct LabelSearchFanoutCommand {
    ...
    request_type: LabelSearchType,
    limit: usize,
    results: Vec<SearchResult>,
}

impl LabelSearchFanoutCommand {
    pub fn new(args: LabelNameSearchArgs, request_type: LabelSearchType) -> ValkeyResult<Self> {
