...
mod ts_labelnamesearch;
mod ts_labelnamesearch_fanout_command;
mod ts_labelstats;
...
use ts_labelnamesearch_fanout_command::LabelNameSearchFanoutCommand;
...
pub(crate) fn register_fanout_operations() -> ValkeyResult<()> {
    ...
    register_fanout_operation::<LabelNameSearchFanoutCommand>()?;
