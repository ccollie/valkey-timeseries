...
class TestTimeSeriesACL(ValkeyTimeSeriesTestCaseBase):
    ...
    def test_timeseries_command_acl_categories(self):
        ...
        expected = {
            ...
            'ts.fillgaps': ([b'write', b'denyoom', b'module', b'movablekeys'], {b'@write', b'@timeseries'}),
            ...
            'ts.stationarity': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@timeseries'}),
            'ts.stats': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@timeseries'}),
