...
class TestTimeSeriesACL(ValkeyTimeSeriesTestCaseBase):
    ...
    def test_timeseries_command_acl_categories(self):
        ...
        expected = {
            ...
            'ts.autocorrelation': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@timeseries'}),
            # movablekeys on the forecasting writers comes from the optional STORE key spec.
            'ts.autoforecast': ([b'write', b'denyoom', b'module', b'movablekeys'], {b'@write', b'@timeseries'}),
            'ts.backtest': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@timeseries'}),
            ...
            'ts.decompose': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@timeseries'}),
            ...
            'ts.features': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@timeseries'}),
            'ts.fillgaps': ([b'write', b'denyoom', b'module', b'movablekeys'], {b'@write', b'@fast', b'@timeseries'}),
            'ts.forecast': ([b'write', b'denyoom', b'module', b'movablekeys'], {b'@write', b'@timeseries'}),
            ...
            'ts.periods': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@timeseries'}),
            ...
            'ts.sanitize': ([b'write', b'denyoom', b'module', b'movablekeys'], {b'@write', b'@timeseries'}),
            'ts.stationarity': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@fast', b'@timeseries'}),
            'ts.stats': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@fast', b'@timeseries'}),
            'ts.trend': ([b'write', b'denyoom', b'module', b'movablekeys'], {b'@write', b'@timeseries'}),
            'ts.xcorr': ([b'readonly', b'denyoom', b'module'], {b'@read', b'@timeseries'}),
        }
