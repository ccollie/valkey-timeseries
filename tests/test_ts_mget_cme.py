...
class TestTimeSeriesMgetCluster(ValkeyTimeSeriesTestCaseBase):
    ...
    def setup_test_data(self, client):
        ...
        client.execute_command('TS.CREATE', 'ts:{shard1}:cpu1', 'LABELS', 'name', 'cpu', 'type', 'usage', 'node',
                               'node1', 'region', 'us-east')
        client.execute_command('TS.CREATE', 'ts:{shard1}:cpu2', 'LABELS', 'name', 'cpu', 'type', 'usage', 'node',
                               'node2', 'region', 'us-east')
        client.execute_command('TS.CREATE', 'ts:{shard2}:cpu3', 'LABELS', 'name', 'cpu', 'type', 'usage', 'node',
                               'node3', 'region', 'us-west')
        client.execute_command('TS.CREATE', 'ts:{shard2}:cpu4', 'LABELS', 'name', 'cpu', 'type', 'temperature', 'node',
                               'node4', 'region', 'us-west')
        client.execute_command('TS.CREATE', 'ts:{shard3}:mem1', 'LABELS', 'name', 'memory', 'type', 'usage', 'node',
                               'node1', 'region', 'eu-central')
        client.execute_command('TS.CREATE', 'ts:{shard3}:mem2', 'LABELS', 'name', 'memory', 'type', 'usage', 'node',
                               'node2', 'region', 'eu-central')
        client.execute_command('TS.CREATE', 'ts:{shard1}:disk1', 'LABELS', 'name', 'disk', 'type', 'usage', 'node',
                               'node1', 'region', 'us-east')
    ...
    def test_mget_cme_with_latest_option(self):
        ...
        self.client.execute_command('TS.CREATERULE', 'ts:{shard1}:cpu1', 'ts:{shard1}:cpu1:avg', 'AGGREGATION', 'avg',
                                    5000)
    ...
    def test_mget_cme_after_node_addition(self):
        ...
        self.client.execute_command('TS.CREATE', 'ts:{new}:cpu5', 'LABELS', 'name', 'cpu', 'type', 'usage', 'node',
                                    'node5')
