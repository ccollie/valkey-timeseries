...
class TestTimeSeriesLabelNamesCME(ValkeySearchClusterTestCaseDebugMode):
    ...
    def test_labelnames_with_time_range(self):
        ...
        cluster_client.execute_command('TS.ADD', TS1, now, 10, 'LABELS', 'name', 'cpu', 'ts1', '1')
        cluster_client.execute_command('TS.ADD', TS2, now + 100, 20, 'LABELS', 'name', 'cpu', 'ts2', '2')
        cluster_client.execute_command('TS.ADD', TS3, now + 200, 30, 'LABELS', 'name', 'cpu', 'ts3', '3')
        cluster_client.execute_command('TS.ADD', TS9, now + 500, 40, 'LABELS', 'name', 'cpu', 'ts9', '9')
