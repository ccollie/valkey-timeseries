...
class TestTimeSeriesLabelValues(ValkeyTimeSeriesTestCaseBase):
    ...
    def test_label_values_with_time_range(self):
        ...
        result = self.client.execute_command('TS.LABELVALUES', 'age', 'FILTER_BY_RANGE', 1000, "+", "FILTER",
                                             'common=1')
        assert result == [b'new']

        # Get values with end time range
        result = self.client.execute_command('TS.LABELVALUES', 'age', 'FILTER_BY_RANGE', '-', 1500, "FILTER",
                                             'common=1')
        assert result == [b'old']
        ...
        result = self.client.execute_command('TS.LABELVALUES', 'name', 'FILTER_BY_RANGE', 900, 2000, "FILTER",
                                             'common=1')
    ...
    def test_label_values_empty_result(self):
        ...
        result = self.client.execute_command('TS.LABELVALUES', 'name', 'FILTER_BY_RANGE', 5000, '+', "FILTER",
                                             'type=usage')
        assert result == []
